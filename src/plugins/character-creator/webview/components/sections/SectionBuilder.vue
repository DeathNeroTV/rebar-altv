    ...
    <div class="flex flex-row gap-3">
        ...
        <template v-else>
            ...
            <div
                ...
                class="flex h-10 w-full cursor-not-allowed select-none items-center justify-center rounded-lg border-2 border-neutral-50 border-opacity-20 bg-opacity-50 font-bold outline-none"
            >
