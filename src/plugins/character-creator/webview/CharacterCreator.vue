...
<template>
    <div class="flex h-screen w-screen overflow-hidden text-white">
        <div class="flex flex-col gap-3 p-3">
            <!-- Tabs Section -->
            <div
                class="left-6 top-6 flex h-20 flex-row gap-3 rounded-lg bg-neutral-950/50 p-3 shadow-lg"
                v-if="!isProcessing"
            >
                <UiIconButton
            ...
            <!-- Tab Section -->
            <div
                class="flex max-h-full flex-col gap-3 overflow-y-auto rounded-lg bg-neutral-950/50 p-3 pb-4 shadow-lg"
            >
