<script lang="ts" setup>
	...
	onMounted(() => {
		otherInventory.value.slots[0] = {
			id: 1,
			icon: 'hamburger',
			desc: 'Es könnte auch ne Pommes sein',
			maxStack: 10,
			name: 'Hamburger',
			quantity: 10,
			category: 'eatable',
