<script lang="ts" setup>
	...
	const handleStart = async () => {
		...
		if (!audio.value) audio.value = new Audio('/sounds/intro.ogg');
		...
		>
			...
			<div class="relative z-10 flex flex-col items-center select-none">
				...
				<div class="w-2/3 h-2 bg-gray-700/40 rounded-xl overflow-hidden mb-10">
					<div
						class="h-full bg-gradient-to-r from-[#007a2e] via-[#00c26b] to-[#008736] transition-[width] duration-700 ease-out shadow-[0_0_15px_#00c26b50] animate-[pulse_3s_infinite]"
			...
			<div
				class="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex items-center gap-3 bg-white/10 border border-gray-100/20 backdrop-blur-md rounded-full px-6 py-3 shadow-lg"
			>
