...
setBulk({
    en: {
        ...
        'discord.auth.expired.session': 'Authentication session has expired. Please restart the alt:V-client.',
        'discord.auth.token.failed': 'Authentication with Discord failed. Please restart the alt:V-client.',
    ...
    de: {
        ...
        'discord.auth.expired.session': 'Authentifizierungssitzung abgelaufen. Starten Sie den alt:V-Client neu',
        'discord.auth.token.failed': 'Authentifizierung bei Discord fehlgeschlagen. Starten Sie den alt:V-Client neu',
